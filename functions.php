...
if (!function_exists('register_navwalker')) :
  function register_navwalker() {
    ...
    // Register Menus
    register_nav_menu('main-menu-left', 'Main menu left');
...
function enqueue_and_register_my_scripts(){
    wp_register_script( 'cookie', get_stylesheet_directory_uri().'/js/cookie.js', array(), '1.0.0', true );
    wp_enqueue_script( 'cookie' );

    wp_register_script( 'swiper', 'https://cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.js', array(), '1.0.0', true );
...
function custom_post_type() {
      ...
      $labels = array(
          'name'                => _x( 'Samochody', 'Post Type General Name', 'bootscore-main' ),
          'singular_name'       => _x( 'Samochód', 'Post Type Singular Name', 'bootscore-main' ),
          'menu_name'           => __( 'Samochody', 'bootscore-main' ),
          'parent_item_colon'   => __( 'Parent Samochód', 'bootscore-main' ),
          'all_items'           => __( 'All Samochody', 'bootscore-main' ),
          'view_item'           => __( 'View Samochód', 'bootscore-main' ),
          'add_new_item'        => __( 'Add New Samochód', 'bootscore-main' ),
          'add_new'             => __( 'Add New', 'bootscore-main' ),
          'edit_item'           => __( 'Edit Samochód', 'bootscore-main' ),
          'update_item'         => __( 'Update Samochód', 'bootscore-main' ),
          'search_items'        => __( 'Search Samochód', 'bootscore-main' ),
          'not_found'           => __( 'Not Found', 'bootscore-main' ),
          'not_found_in_trash'  => __( 'Not found in Trash', 'bootscore-main' ),
      );
        
  // Set other options for Custom Post Type
        
      $args = array(
          'label'               => __( 'Samochody', 'bootscore-main' ),
          'description'         => __( 'Samochód news and reviews', 'bootscore-main' ),
          'labels'              => $labels,
